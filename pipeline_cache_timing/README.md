...
- Cold creation of 24 graphics handles over six format/depth identities and one
  compute pipeline. Blend and triangle/line topology dimensions share a
  pipeline and switch at command-recording time.
